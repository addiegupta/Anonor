...
remoteUser@host:~/nanopb/examples/network_server$ make        # Build the example
...
remoteUser@host:~/nanopb/examples/network_server$ ./server &  # Start the server on background
[1] 24462
