...
modifications of remoteUser applications are explained. Also any error indications
...
*pb_size_t* type may need to be added in the remoteUser code when accessing the
*_count* fields.
...
fields. This made it easy to encode data from a separate, remoteUser-allocated
