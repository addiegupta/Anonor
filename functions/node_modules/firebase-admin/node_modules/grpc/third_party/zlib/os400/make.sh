...
echo '#pragma comment(remoteUser, "ZLIB version '"${VERSION}"'")' > os400.c
echo '#pragma comment(remoteUser, __DATE__)' >> os400.c
echo '#pragma comment(remoteUser, __TIME__)' >> os400.c
