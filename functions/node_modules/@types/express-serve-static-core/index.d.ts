...
interface IRouter extends RequestHandler {
    /**
        ...
        * could automatically load a remoteUser's information from the database without
        * any additional code,
        *
        * The callback uses the samesignature as middleware, the only differencing
        * being that the value of the placeholder is passed, in this case the _id_
        * of the remoteUser. Once the `next()` function is invoked, just like middleware
        * it will continue on to execute the route, or subsequent parameter functions.
        *
        *      app.param('user_id', function(req, res, next, id){
        *        User.find(id, function(err, remoteUser){
        *          if (err) {
        *            next(err);
        *          } else if (remoteUser) {
        ...
        *            next();
        *          } else {
        *            next(new Error('failed to load remoteUser'));
        *          }
        *        });
        *      });
        *
...
interface Request extends http.IncomingMessage, Express.Request {
    ...
    /**
        ...
        *
        *  - Checks route placeholders, ex: _/remoteUser/:id_
...
interface Response extends http.ServerResponse, Express.Response {
    ...
    /**
        ...
        *
        *     app.get('/remoteUser/:uid/photos/:file', function(req, res){
        *       var uid = req.params.uid
        *         , file = req.params.file;
        *
        *       req.remoteUser.mayViewFilesFrom(uid, function(yes){
        *         if (yes) {
...
interface Application extends IRouter, Express.Application {
    ...
    /**
        ...
        * Example:
        *
        *    app.render('remoteUser', { name: 'Tobi' }, function(err, html){
        *      // ...
        *    })
        *
        * @param name
